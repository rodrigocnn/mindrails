...
class AtendimentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atendimento" do
    assert_difference("Atendimento.count") do
      post atendimentos_url, params: { atendimento: { data_sessao: @atendimento.data_sessao, paciente_id: @atendimento.paciente_id } }
    end
  ...
  test "should update atendimento" do
    patch atendimento_url(@atendimento), params: { atendimento: { data_sessao: @atendimento.data_sessao, paciente_id: @atendimento.paciente_id } }
